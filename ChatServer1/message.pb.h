...
/* @@protoc_insertion_point(class_definition:message.TextChatMsgRsp) */ {
 ...
 public:
  ...
  // accessors -------------------------------------------------------
  enum : int {
    kTestmsgsFieldNumber = 4,
    kErrorFieldNumber = 1,
    kFromuidFieldNumber = 2,
    kTouidFieldNumber = 3,
  };
  // repeated .message.TextChatData testmsgs = 4;
  int testmsgs_size() const;
  private:
  int _internal_testmsgs_size() const;

  public:
  void clear_testmsgs() ;
  ::message::TextChatData* mutable_testmsgs(int index);
  ::google::protobuf::RepeatedPtrField<::message::TextChatData>* mutable_testmsgs();

  private:
  const ::google::protobuf::RepeatedPtrField<::message::TextChatData>& _internal_testmsgs() const;
  ::google::protobuf::RepeatedPtrField<::message::TextChatData>* _internal_mutable_testmsgs();
  public:
  const ::message::TextChatData& testmsgs(int index) const;
  ::message::TextChatData* add_testmsgs();
  const ::google::protobuf::RepeatedPtrField<::message::TextChatData>& testmsgs() const;
  // int32 error = 1;
  void clear_error() ;
  ::int32_t error() const;
  void set_error(::int32_t value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::RepeatedPtrField< ::message::TextChatData > testmsgs_;
    ::int32_t error_;
    ::int32_t fromuid_;
    ::int32_t touid_;
    ::google::protobuf::internal::CachedSize _cached_size_;
...
/* @@protoc_insertion_point(class_definition:message.TextChatMsgReq) */ {
 ...
 public:
  ...
  // accessors -------------------------------------------------------
  enum : int {
    kTestmsgsFieldNumber = 3,
    kFromuidFieldNumber = 1,
    kTouidFieldNumber = 2,
  };
  // repeated .message.TextChatData testmsgs = 3;
  int testmsgs_size() const;
  private:
  int _internal_testmsgs_size() const;
...
// repeated .message.TextChatData testmsgs = 3;
inline int TextChatMsgReq::_internal_testmsgs_size() const {
  return _internal_testmsgs().size();
}
inline int TextChatMsgReq::testmsgs_size() const {
  return _internal_testmsgs_size();
}
inline void TextChatMsgReq::clear_testmsgs() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.testmsgs_.Clear();
}
inline ::message::TextChatData* TextChatMsgReq::mutable_testmsgs(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:message.TextChatMsgReq.testmsgs)
  return _internal_mutable_testmsgs()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::message::TextChatData>* TextChatMsgReq::mutable_testmsgs()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:message.TextChatMsgReq.testmsgs)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_testmsgs();
}
inline const ::message::TextChatData& TextChatMsgReq::testmsgs(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:message.TextChatMsgReq.testmsgs)
  return _internal_testmsgs().Get(index);
}
inline ::message::TextChatData* TextChatMsgReq::add_testmsgs() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::message::TextChatData* _add = _internal_mutable_testmsgs()->Add();
  // @@protoc_insertion_point(field_add:message.TextChatMsgReq.testmsgs)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::message::TextChatData>& TextChatMsgReq::testmsgs() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:message.TextChatMsgReq.testmsgs)
  return _internal_testmsgs();
}
inline const ::google::protobuf::RepeatedPtrField<::message::TextChatData>&
TextChatMsgReq::_internal_testmsgs() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.testmsgs_;
}
inline ::google::protobuf::RepeatedPtrField<::message::TextChatData>*
TextChatMsgReq::_internal_mutable_testmsgs() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.testmsgs_;
}
...
// repeated .message.TextChatData testmsgs = 4;
inline int TextChatMsgRsp::_internal_testmsgs_size() const {
  return _internal_testmsgs().size();
}
inline int TextChatMsgRsp::testmsgs_size() const {
  return _internal_testmsgs_size();
}
inline void TextChatMsgRsp::clear_testmsgs() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.testmsgs_.Clear();
}
inline ::message::TextChatData* TextChatMsgRsp::mutable_testmsgs(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:message.TextChatMsgRsp.testmsgs)
  return _internal_mutable_testmsgs()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::message::TextChatData>* TextChatMsgRsp::mutable_testmsgs()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:message.TextChatMsgRsp.testmsgs)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_testmsgs();
}
inline const ::message::TextChatData& TextChatMsgRsp::testmsgs(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:message.TextChatMsgRsp.testmsgs)
  return _internal_testmsgs().Get(index);
}
inline ::message::TextChatData* TextChatMsgRsp::add_testmsgs() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::message::TextChatData* _add = _internal_mutable_testmsgs()->Add();
  // @@protoc_insertion_point(field_add:message.TextChatMsgRsp.testmsgs)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::message::TextChatData>& TextChatMsgRsp::testmsgs() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:message.TextChatMsgRsp.testmsgs)
  return _internal_testmsgs();
}
inline const ::google::protobuf::RepeatedPtrField<::message::TextChatData>&
TextChatMsgRsp::_internal_testmsgs() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.testmsgs_;
}
inline ::google::protobuf::RepeatedPtrField<::message::TextChatData>*
TextChatMsgRsp::_internal_mutable_testmsgs() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.testmsgs_;
}
